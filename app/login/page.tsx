...
function LoginContent() {
  ...
  useEffect(() => {
    if (authError) setError('Sign-in failed. Please check your credentials and try again.')
  }, [authError])
          ...
          <div className="flex rounded-lg bg-white/5 p-1 mb-6 gap-1">
            <button
              ...
              className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${
                tab === 'google' ? 'bg-blue text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
              Google
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${
                tab === 'email' ? 'bg-blue text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
              Email
            </button>
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-600 focus:outline-none focus:border-blue/50 focus:bg-white/8 transition-colors text-sm"
                />
              </div>
              <div>
